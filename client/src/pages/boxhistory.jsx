...
export default function BoxHistory() {
  ...
  return (
    <section className="max-w-3xl mx-auto p-6 space-y-6">
      ...
      {entries.map((e, i) => (
        <div key={i} className="p-4 border border-base-300 rounded bg-base-100 shadow">
          <h2 className="font-semibold text-lg mb-2">Zyklus {i + 1}</h2>
